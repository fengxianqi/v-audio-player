...
// module
exports.push([module.i, ".v-audio-player[data-v-397d5805]{width:375px}.v-audio-player p[data-v-397d5805]{margin:0}.v-audio-player .audio-wrapper[data-v-397d5805]{padding:10px 15px;background:#f5f5f5;border-radius:2px;display:-webkit-box;display:-ms-flexbox;display:flex;font-size:0;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.v-audio-player .audio-wrapper .audio-player[data-v-397d5805]{-webkit-box-flex:0;-ms-flex:0 0 44px;flex:0 0 44px;width:44px;height:44px}.v-audio-player .audio-wrapper .audio-player.play[data-v-397d5805]{background:url(" + escape(__webpack_require__("1b1a")) + ") no-repeat;background-size:cover}.v-audio-player .audio-wrapper .audio-player.pause[data-v-397d5805]{background:url(" + escape(__webpack_require__("674d")) + ") no-repeat;background-size:cover}.v-audio-player .audio-wrapper .audio-info[data-v-397d5805]{-webkit-box-flex:1;-ms-flex:1;flex:1;padding-left:15px}.v-audio-player .audio-wrapper .audio-info .audio-name[data-v-397d5805]{font-size:15px;line-height:21px;font-weight:400;color:#333}.v-audio-player .audio-wrapper .audio-info .progress-wrapper[data-v-397d5805]{height:3px;margin:7px auto;width:246px;position:relative}.v-audio-player .audio-wrapper .audio-info .progress-wrapper[data-v-397d5805]:before{content:\"\";position:absolute;top:px2rem(-10px);left:px2rem(-10px);right:px2rem(-10px);bottom:px2rem(-10px)}.v-audio-player .audio-wrapper .audio-info .progress-wrapper .progress-bar[data-v-397d5805]{background:rgba(0,0,0,.3);position:relative;height:100%;cursor:pointer}.v-audio-player .audio-wrapper .audio-info .progress-wrapper .progress-bar .progress[data-v-397d5805]{-webkit-box-sizing:border-box;box-sizing:border-box;position:absolute;height:100%;background:#50c878;width:0}.v-audio-player .audio-wrapper .audio-info .progress-wrapper .progress-bar .progress-btn[data-v-397d5805]{position:relative;position:absolute;left:-3.5px;width:7px;height:7px;top:-2px;border-radius:50%;background:#50c878}.v-audio-player .audio-wrapper .audio-info .progress-wrapper .progress-bar .progress-btn[data-v-397d5805]:before{content:\"\";position:absolute;top:px2rem(-10px);left:px2rem(-10px);right:px2rem(-10px);bottom:px2rem(-10px)}.v-audio-player .audio-wrapper .audio-info .time-wrapper[data-v-397d5805]{height:14px;font-size:12px;line-height:14px;font-weight:300;color:#666;zoom:1}.v-audio-player .audio-wrapper .audio-info .time-wrapper[data-v-397d5805]:after{clear:both;content:\"\"}.v-audio-player .audio-wrapper .audio-info .time-wrapper .time.time-l[data-v-397d5805]{float:left}.v-audio-player .audio-wrapper .audio-info .time-wrapper .time.time-r[data-v-397d5805]{float:right}", ""]);
...
// load the styles
var content = __webpack_require__("2c06");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("28cc3913", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_v_audio_player_vue_vue_type_style_index_0_id_397d5805_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("31fd");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_v_audio_player_vue_vue_type_style_index_0_id_397d5805_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_v_audio_player_vue_vue_type_style_index_0_id_397d5805_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_v_audio_player_vue_vue_type_style_index_0_id_397d5805_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./src/v-audio-player.vue?vue&type=template&id=397d5805&scoped=true&
...
// EXTERNAL MODULE: ./src/v-audio-player.vue?vue&type=style&index=0&id=397d5805&scoped=true&lang=scss&
var v_audio_playervue_type_style_index_0_id_397d5805_scoped_true_lang_scss_ = __webpack_require__("7ed9");
